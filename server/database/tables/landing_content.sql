...
('testimonials', '{"id":"t1","quote":"User-friendly interface that is easy to navigate and use. The CRM also offers a range of features such as lead tracking, task management, and email integration.","author":"Shivani Mistry","role":"Operations Director","company":"TechServ Co","avatar":"👩‍💼","avatarBg":"from-violet-400 to-violet-600","stars":5}', 1),
('testimonials', '{"id":"t2","quote":"We manage over 500 service requests daily across three departments. FlowCRM\'s role-based queues mean nothing falls through the cracks anymore.","author":"Marcus Rivera","role":"Service Manager","company":"GlobalOps Inc","avatar":"👨‍💻","avatarBg":"from-blue-400 to-blue-600","stars":4}', 2),
...
('hero_stats', '{"label":"Active companies","value":"20+","sub":"across 45 countries","color":"text-indigo-400"}', 2),
